...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux d&apos;Action - CrazyGames" },
    { name: "description", content: "Découvrez les meilleurs jeux d&apos;action sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getGamesByCategory("action");
  return json({ games });
}
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">Jeux d&apos;Action</h1>
      </div>
