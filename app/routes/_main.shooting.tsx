...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux de Tir - CrazyGames" },
    { name: "description", content: "Découvrez les meilleurs jeux de tir sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getGamesByCategory("shooting");
  return json({ games });
}

export default function ShootingGames() {
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        <svg className="w-6 h-6 text-red-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M10.894 2.553a1 1 0 00-1.788 0l-7 14a1 1 0 001.169 1.409l5-1.429A1 1 0 009 15.571V11a1 1 0 112 0v4.571a1 1 0 00.725.962l5 1.428a1 1 0 001.17-1.408l-7-14z" clipRule="evenodd"></path>
        </svg>
        <h1 className="text-2xl font-bold text-white">Jeux de Tir</h1>
      </div>
