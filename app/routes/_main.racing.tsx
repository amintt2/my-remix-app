...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux de Course - CrazyGames" },
    { name: "description", content: "Découvrez les meilleurs jeux de course sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getGamesByCategory("racing");
  return json({ games });
}
    ...
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        <svg className="w-6 h-6 text-green-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M3 4a1 1 0 00-1 1v10a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H11a1 1 0 001-1v-5h2v5a1 1 0 001 1h1.05a2.5 2.5 0 014.9 0H19a1 1 0 001-1V9a3 3 0 00-3-3h-3V4a1 1 0 00-1-1H3z"></path>
        </svg>
        <h1 className="text-2xl font-bold text-white">Jeux de Course</h1>
      </div>
