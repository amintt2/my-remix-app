...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux de Simulation - CrazyGames" },
    { name: "description", content: "Découvrez les meilleurs jeux de simulation sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getGamesByCategory("simulation");
  return json({ games });
}
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        <svg className="w-6 h-6 text-cyan-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm0 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clipRule="evenodd"></path>
        </svg>
        <h1 className="text-2xl font-bold text-white">Jeux de Simulation</h1>
      </div>
