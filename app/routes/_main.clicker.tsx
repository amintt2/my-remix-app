...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux de Clicker - CrazyGames" },
    { name: "description", content: "Découvrez les meilleurs jeux de clicker sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getGamesByCategory("clicker");
  return json({ games });
}

export default function ClickerGames() {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">Jeux de Clicker</h1>
      </div>
