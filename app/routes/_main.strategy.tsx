...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux de Stratégie - CrazyGames" },
    { name: "description", content: "Découvrez les meilleurs jeux de stratégie sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getGamesByCategory("strategy");
  return json({ games });
}
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">Jeux de Stratégie</h1>
      </div>
