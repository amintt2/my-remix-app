...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux de Puzzle - CrazyGames" },
    { name: "description", content: "Découvrez les meilleurs jeux de puzzle sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getGamesByCategory("puzzle");
  return json({ games });
}
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        <svg className="w-6 h-6 text-purple-500 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path d="M10 3.5a1.5 1.5 0 013 0V4a1 1 0 001 1h3a1 1 0 011 1v3a1 1 0 01-1 1h-.5a1.5 1.5 0 000 3h.5a1 1 0 011 1v3a1 1 0 01-1 1h-3a1 1 0 01-1-1v-.5a1.5 1.5 0 00-3 0v.5a1 1 0 01-1 1H6a1 1 0 01-1-1v-3a1 1 0 00-1-1h-.5a1.5 1.5 0 010-3H4a1 1 0 001-1V6a1 1 0 011-1h3a1 1 0 001-1v-.5z"></path>
        </svg>
        <h1 className="text-2xl font-bold text-white">Jeux de Puzzle</h1>
      </div>
