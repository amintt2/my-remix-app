...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux Populaires - CrazyGames" },
    { name: "description", content: "Découvrez les jeux les plus populaires sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getPopularGames();
  return json({ games });
}
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">Jeux Populaires</h1>
      </div>
