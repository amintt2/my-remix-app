...
export const meta: MetaFunction = () => {
  return [
    { title: "Jeux de Sports - CrazyGames" },
    { name: "description", content: "Découvrez les meilleurs jeux de sports sur CrazyGames." },
  ];
};

export async function loader() {
  const games = gameService.getGamesByCategory("sports");
  return json({ games });
}
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold text-white">Jeux de Sports</h1>
      </div>
